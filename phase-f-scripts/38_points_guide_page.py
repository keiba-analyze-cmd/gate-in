#!/usr/bin/env python3
"""
Task #38: ポイントシステム説明ページ
- src/app/(main)/guide/points/page.tsx を新規作成
- レース詳細のポイント目安にリンク追加
"""
...
guide_dir = "src/app/(main)/guide/points"
os.makedirs(guide_dir, exist_ok=True)
with open(f"{guide_dir}/page.tsx", "w") as f:
    f.write(POINTS_GUIDE)
print(f"✅ {guide_dir}/page.tsx")

# ============================================================
# 2. レース詳細のポイント目安にリンク追加
# ============================================================

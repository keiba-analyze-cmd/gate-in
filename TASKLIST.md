...
```
Phase B-fix  → バグ2件を即時修正
Phase C-social → ユーザーFB対応（1週間）
...
## 🐛 Phase B-fix: バグ修正（最優先）

| # | タスク | 説明 | 優先度 | 工数 | 対象ファイル |
|---|--------|------|--------|------|-------------|
| 14 | 投票集計が自分の分しか表示されない | 全投票者の集計結果を表示すべき | 🔴最優先 | 0.5日 | VoteDistribution.tsx, /api/races/[raceId]/votes |
| 15 | 獲得ポイント目安に2〜3番人気がない | 1番人気の次が4〜6番人気。行を追加 | 🔴最優先 | 0.5h | races/[raceId]/page.tsx |

...
export function KarteClient() {
  ...
  const getMarkCount = (mark: MarkFilter) => {
    if (mark === "all") return karteList.length;
    return karteList.filter(k => k.mark === mark).length;
  };
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    ...
                    <p className="text-2xl font-black">{currentItem.horseName}</p>
                  </div>
                </div>
                ...
                <div className="px-5 pb-5 flex gap-3">
                  <button
                    ...
                    disabled={saving}
                    className="flex-1 bg-gray-200 text-gray-700 font-bold py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-gray-300 transition-colors disabled:opacity-50"
                  >
      ...
      <Link
        ...
        className="block bg-white rounded-2xl border border-gray-100 p-4 text-center font-bold text-green-600 hover:bg-green-50 transition-colors"
      >
        🔔 追跡リストを見る →
      </Link>
    </div>

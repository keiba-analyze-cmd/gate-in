        ...
        <div className="flex items-start gap-4 mb-4">
          ...
          <div className="flex-1">
            <div className="flex items-center justify-between">
              ...
              {!isOwnProfile && (
                <div className="flex items-center gap-2"><FollowButton targetUserId={userId} initialFollowing={isFollowing} /><BlockButton targetUserId={userId} initialBlocked={isBlocked} /></div>
              )}
            </div>
            {profile.bio && (
